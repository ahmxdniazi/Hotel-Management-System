...
public class Manager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Complain and queries");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String Complainandqueries  = jTextField1.getText();
            
            try{
                Connection Conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/hotelsystem1","root","");
                PreparedStatement ps = Conn.prepareStatement("insert into manager Value (?)");
                ps.setString(1, Complainandqueries );
                ps.executeUpdate();
